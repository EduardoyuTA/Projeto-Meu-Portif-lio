      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="assets/images/projects/projetocarro.png"
              alt="projeto carro."
            />
            <div class="buttons">
              <a href="https://github.com/EduardoyuTA/Projeto-Loja-de-Carro" target="_blank" title="Repositório no Github">
                <svg
                ...
                >
                  ...
                  <path
                    ...
                    fill="rgba(255, 235, 255, 1)"
                  />
                </svg>
              </a>
              <a href="https://eduardoyuta.github.io/Projeto-Loja-de-Carro" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Loja de carros desenvolvida com tecnológias web.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          <h3>Loja e Amantes de Café</h3>
          <div class="img-wrapper">
            <img
              src="assets/images/projects/projetocafeteria.png"
              alt="Imagem tema do projeto de desafio de código."
            />
            <div class="buttons">
              <a href="https://github.com/EduardoyuTA/Projeto-Cafeteria" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://eduardoyuta.github.io/Projeto-Cafeteria" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Projeto de uma loja de café, desenvolvido com tecnológias web.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          <h3>Replica do Spotify</h3>
          <div class="img-wrapper">
          ...
          <p>Projeto que replica perfeitamente o Spotify utilizando tecnológias web</p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          <h3>Clínica e Petshop Petscoob</h3>
          <div class="img-wrapper">
            <img
              src="assets/images/projects/projetopetscoob.png"
              alt="Imagem tema do projeto de desafio de código."
            />
            <div class="buttons">
          ...
          <p>
            Projeto de uma Clínica Veterinária e Petshop.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
                <div class="card">
          ...
          <p>
            O presente site que desenvolvi para apresentar meus projetos e habilidades.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
